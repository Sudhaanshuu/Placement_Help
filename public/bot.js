...
async function getResponse(userMessage) {
    ...
    if (
        ...
        return customResponses.greeting[
            Math.floor(Math.random() * customResponses.greeting.length)
        ];
    }
    ...
    try {
        ...
        if (!botResponse.toLowerCase().includes("princy") &&
            !botResponse.toLowerCase().includes("placement") &&
            !botResponse.toLowerCase().includes("education")
        ) {
...
function startSpeechRecognition() {
    ...
    recognition.onerror = (event) => {
        ...
        addChatbotMessage(
            "I'm having trouble understanding you. Could you please type your question instead?"
        );
    };
